...
QuorumEntry.prototype.isValidQuorumSig = async function isValidQuorumSig() {
  if (this.isOutdatedRPC) {
    throw new Error(
      'Quorum cannot be verified: node running on outdated HellarCore version (< 0.16)'
    );
  }
...
QuorumEntry.prototype.getAllQuorumMembers = function getAllQuorumMembers(
  ...
  // TODO does not work for hip-0024 llmq type quorums
  // See https://github.com/hellarcore/hips/blob/master/hip-0024.md#changes-to-the-initialization-phase
