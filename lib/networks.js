 ...
 * @param {Number} data.xpubkey256bit - The extended public key magic for HIP14
 * @param {Number} data.xprivkey256bit - The extended private key magic for HIP14
...
addNetwork({
  ...
  xpubkey256bit: 0x0eecefc5,    // 'dpmp' (hellarcore mainnet public)
  xprivkey256bit: 0x0eecf02e,   // 'dpms' (hellarcore mainnet secret)
  networkMagic: 0xbf0c6bbd,
  port: 9999,
  dnsSeeds: [
    'dnsseed.darkcoin.io',
    'dnsseed.hellardot.io',
    'dnsseed.masternode.io',
    'dnsseed.hellarcore.io',
  ],
});
...
addNetwork({
  name: 'testnet',
  alias: ['regtest', 'devnet', 'pronet', 'local'],
  pubkeyhash: 0x8c,
  privatekey: 0xef,
  scripthash: 0x13,
  xpubkey:    0x43587cf,    // 'tpub' (Bitcoin Default)
  xprivkey:   0x04358394,   // 'tprv' (Bitcoin Default)
  xpubkey256bit:    0x0eed270b,   // 'dptp' (hellarcore testnet public) 
  xprivkey256bit:   0x0eed2774// 'dpts' (hellarcore testnet secret)
});
...
var TESTNET = {
  ...
  DNS_SEEDS: [
    ...
    'test-dnsseed.spork-node.pw',
    'test-dnsseed.masternode.pw',
  ],
};
