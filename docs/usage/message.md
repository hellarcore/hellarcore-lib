...
**Description**: Will sign a message with a given Hellar private key.
...
**Description**: Will return a boolean of the signature is valid for a given hellar address.  
...
| parameter   | type           | required | Description    |
| ----------- | -------------- | -------- | -------------- |
| **address** | Address/String | yes      | A hellar address |
