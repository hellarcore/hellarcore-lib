...
For detailed technical information about a block please visit [Blocks](https://hellar-docs.github.io/en/glossary/block) on the Hellar Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://hellar-docs.github.io/en/developer-reference#block-headers) page on the Hellar Developer Reference Wiki.
