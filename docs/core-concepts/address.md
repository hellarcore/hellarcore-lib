...
Represents a Hellar address. Addresses are the most popular way to make Hellar transactions. See [the Hellar documentation](https://hellar-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/hellarcore/bitcore-hellar/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/hellarcore/bitcore-hellar/tree/master/lib/errors/spec.js).
