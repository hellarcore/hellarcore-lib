...
describe('BufferReader', function () {
  ...
  describe('#readUInt64LEBN', function () {
    ...
    it('should return max number of hellars', function () {
      var maxhellars = 21000000 * 1e8;
      var maxhellarsBuffer = Buffer.from('0040075af0750700', 'hex');
      var br = new BufferReader(maxhellarsBuffer);
      br.readUInt64LEBN().toNumber().should.equal(maxhellars);
    });
