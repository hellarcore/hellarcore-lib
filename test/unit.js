...
describe('Unit', function () {
  ...
  it('has property accesors "BTC", "mBTC", "uBTC", "bits", and "hellars"', function () {
    ...
    unit.hellars.should.equal(120000000);
  });
  ...
  it('a string amount is allowed', function () {
    ...
    unit = Unit.fromhellars('8999');
    unit.hellars.should.equal(8999);
  ...
  it('converts to hellars correctly', function () {
  ...
  it('exposes unit codes', function () {
    ...
    should.exist(Unit.hellars);
    Unit.hellars.should.equal('hellars');
  });
  ...
  it('exposes a method that converts to different units', function () {
    ...
    unit.to(Unit.hellars).should.equal(unit.hellars);
  });
  ...
  it('exposes shorthand conversion methods', function () {
    ...
    unit.tohellars().should.equal(unit.hellars);
  });
  ...
  it('inspect method displays nicely', function () {
    var unit = new Unit(1.3, 'BTC');
    unit.inspect().should.equal('<Unit: 130000000 hellars>');
  });
