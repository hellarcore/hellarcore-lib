...
describe('Proposal', function () {
  ...
  it('should create new proposal', function () {
    ...
    proposal.type = 1;
    proposal.url = 'http://www.hellar.io';
  ...
  it('should not throw error if payment address is P2SH', function () {
    ...
    proposal2.name = 'Proposal-36-HellarATM';
    ...
    proposal2.type = 1;
    proposal2.url = 'https://www.hellarcentral.org/p/Proposal-36-HellarATM';
  ...
  it('should parse a serialised datahex proposal', function () {
    ...
    expect(proposal1.url).to.equal(
      'https://www.hellarcentral.org/p/test_proposal_1519097947'
    );
