...
bitcore.versionGuard = function (version) {
  if (version !== undefined) {
    var message =
      'More than one instance of hellarcore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of hellarcore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._hellarcore);
global._hellarcore = bitcore.version;
...
bitcore.deps._ = require('lohellar');
